...
public class RaidInfoShowActivity extends AppCompatActivity {
    ...
    private void setDefault(final Raid body) {
        ...
        writeReview.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(), PostReviewActivity.class).putExtra("resId", resId).putExtra("resTitle", resTitle.getText().toString()).putExtra("resAddress", resAddress.getText().toString().trim()).putExtra("raidId", intent.getStringExtra("raidId")));
